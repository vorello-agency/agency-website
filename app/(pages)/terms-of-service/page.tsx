      ...
      <main className="bg-carbon-black flex flex-1 flex-col pt-32 pb-20 md:pt-40 md:pb-28">
        <Container className="max-w-3xl">
          ...
          <div className="prose prose-invert prose-sm text-copy-muted [&_h2]:text-chrome-highlight [&_strong]:text-chrome-highlight/90 [&_a]:text-neon-blue hover:[&_a]:text-chrome-highlight max-w-none space-y-8 leading-relaxed [&_a]:underline [&_a]:underline-offset-2 [&_a]:transition-colors [&_h2]:mt-10 [&_h2]:mb-3 [&_h2]:text-lg [&_h2]:font-semibold">
            <p>
              Al acceder y utilizar el sitio web de <strong>{BRAND_FULL_NAME}</strong> (
              {BRAND_DOMAIN}), aceptás los siguientes términos y condiciones de uso.
            </p>
            ...
            <p>
              Este sitio web tiene como propósito presentar los servicios, el proceso de trabajo y
              la información de contacto de {BRAND_FULL_NAME}. El contenido es informativo y no
              constituye una oferta contractual vinculante.
            </p>

            <h2>2. Propiedad intelectual</h2>
            <p>
              Todo el contenido del sitio — incluyendo diseño, textos, gráficos, logotipos, íconos,
              código fuente y estructura visual — es propiedad de {BRAND_FULL_NAME} o sus
            ...
            <p>
              {BRAND_FULL_NAME} no garantiza la disponibilidad ininterrumpida del sitio ni se
              responsabiliza por errores u omisiones en el contenido. El uso del sitio es bajo tu
              propia responsabilidad.
            </p>

            <h2>4. Enlaces externos</h2>
            <p>
              El sitio puede contener enlaces a sitios web de terceros. {BRAND_FULL_NAME} no se
              responsabiliza por el contenido, políticas de privacidad o prácticas de dichos sitios
              externos.
            </p>
            ...
            <p>
              ...
              cambios serán efectivos a partir de su publicación en esta página.
            </p>

            <h2>6. Legislación aplicable</h2>
            <p>
              Estos términos se rigen por las leyes de la República Oriental del Uruguay. Cualquier
              controversia será sometida a la jurisdicción de los tribunales competentes de
              Montevideo, Uruguay.
            </p>
