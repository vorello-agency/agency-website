...
export default function CTA() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // 5. Pop reveal of the conversion buttons (power2.out for clean, premium feel)
      tl.fromTo(
        ".cta-buttons",
  ...
  return (
    ...
    >
      ...
      <Container className="px-1 sm:px-4 md:px-6 lg:px-16 xl:px-20 2xl:px-8">
        <div
          ref={cardRef}
          className="md:border-steel-grey/30 md:bg-graphite-metal relative mx-auto max-w-xl overflow-hidden border-0 bg-transparent px-5 pt-10 pb-10 sm:px-8 md:max-w-2xl md:rounded-2xl md:border md:px-10 md:pt-16 md:pb-12 md:text-center lg:max-w-3xl lg:pt-20 lg:pb-14 xl:max-w-4xl 2xl:max-w-6xl 2xl:pt-24 2xl:pb-16"
          style={{ opacity: 0 }}
        >
          ...
          <p className="cta-desc text-chrome-highlight/75 relative z-10 mx-auto mb-10 mt-8 text-base leading-relaxed md:text-xl md:mt-10 lg:text-[clamp(1.05rem,1.15vw,1.4rem)] 2xl:mb-12 text-balance">
            Hagamos que tu producto funcione como realmente debería.<br />
            Cuéntanos qué quieres crear y evaluaremos la viabilidad técnica en menos de 24 horas hábiles.
          </p>

          <div className="cta-buttons relative z-10 flex flex-col items-center justify-start gap-4 md:flex-row md:justify-center">
            <Link href="/start" className="w-full focus-visible:outline-none md:w-auto">
              <Button variant="primary-blue" size="lg" className="w-full" withArrow>
                Solicitar propuesta técnica
              </Button>
            </Link>
            <Link href="/contact" className="w-full focus-visible:outline-none md:w-auto">
