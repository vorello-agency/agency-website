...
export default function FooterContact() {
  return (
    <div className="footer-col flex flex-col gap-4 xxs:col-span-2 xxs:border-t xxs:border-steel-grey/20 xxs:pt-6 xs:grid xs:grid-cols-2 xs:gap-x-12 xs:gap-y-6 sm:border-t-0 sm:pt-0 sm:flex sm:flex-col sm:gap-4">
      {/* Group A: Contact Info */}
      ...
      {/* Group C: Social Profiles */}
      <div className="footer-social-row flex items-center gap-2 pt-4 mt-auto xxs:col-span-2 xxs:col-start-1 xxs:justify-center xxs:border-t xxs:border-steel-grey/20 xxs:w-full xxs:pt-6 xxs:mt-2 sm:border-t-0 sm:pt-4 sm:justify-start sm:mt-auto">
