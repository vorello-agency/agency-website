...
export default function Footer() {
  ...
  return (
    <footer
      ref={footerRef}
      className="border-steel-grey/20 bg-carbon-black text-chrome-deep relative mt-auto overflow-hidden border-t pt-16 pb-16 sm:pb-24 md:pt-20 md:pb-32 lg:pb-48"
    >
      {/* ── Main content grid ── */}
      <Container className="relative z-10 flex flex-col items-start justify-between gap-10 px-4 pb-8 sm:px-6 md:flex-row md:pb-20 lg:px-16 xl:px-16!">
        {/* — Brand column — */}
        <div className="footer-col flex w-full max-w-md flex-col gap-5">
          ...
          <div className="mt-3 flex flex-wrap items-center gap-3">
            ...
            <div className="bg-graphite-metal/30 border-steel-grey/30 inline-flex w-full flex-col gap-2 rounded-lg border p-3 select-none sm:flex-row sm:items-center sm:gap-3 sm:p-1 sm:pl-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-chrome-highlight font-mono text-[11px] font-medium tracking-tight whitespace-nowrap select-none">
            ...
            <div className="bg-graphite-metal/30 border-steel-grey/30 flex w-full flex-col gap-2 rounded-lg border px-3 py-2 select-none sm:flex-row sm:gap-3 sm:pl-4">
              <div className="flex min-w-0 flex-col">
                <span className="text-chrome-highlight flex items-center gap-2 font-mono text-[11px] font-medium tracking-tight whitespace-nowrap">
                ...
                <span className="text-copy-muted/60 mt-1 hidden pl-3 font-mono text-[10px] tracking-tight whitespace-nowrap min-[375px]:block">
                  Hub tecnológico en América Latina
                </span>
              </div>
              <span
                className="text-chrome-highlight pl-4 font-mono text-[11px] font-medium tracking-tight whitespace-nowrap sm:my-auto sm:ml-auto sm:pl-0"
        ...
        <div className="flex flex-col items-start gap-x-12 gap-y-6 pl-2 sm:flex-row sm:pl-0 lg:gap-x-16">
          {/* — Services column — */}
              ...
              {AGENCY_LINKS.map((link) => (
                <li key={link.label}>
                  <Link
                    href={link.href}
                    onClick={(e) =>
                      link.href.includes("#") ? handleNavLinkClick(e, link.href) : undefined
                    }
                    className={linkClass}
                  >
                    <span>{link.label}</span>
      ...
      {/* ── Gradient divider ── */}
      <div
        className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-16 xl:px-20 2xl:px-8"
        aria-hidden="true"
      >
      ...
      <div className="footer-bottom relative z-10 py-8">
        <Container className="flex flex-col items-center gap-6 text-xs sm:flex-row sm:justify-between sm:gap-4">
          <p className="text-copy-muted text-center sm:text-left">
      ...
      <div
        ref={signatureRef}
        className="absolute bottom-0 left-1/2 z-0 h-24 w-full max-w-screen-2xl -translate-x-1/2 translate-y-4 select-none sm:h-40 sm:translate-y-8 md:h-56 md:translate-y-16 lg:-translate-y-6 xl:-translate-y-8"
      >
...
function SocialIcon({
  ...
  return (
    <a
      ...
      rel="noopener noreferrer"
      aria-label={label}
      className="footer-social-icon text-copy-muted hover:text-chrome-highlight border-steel-grey/10 hover:border-steel-grey/30 bg-graphite-metal/20 hover:bg-graphite-metal/40 focus-visible:ring-electric-violet rounded-lg border p-2 transition-all duration-200 hover:scale-110 focus-visible:ring-1 focus-visible:outline-none"
    >
